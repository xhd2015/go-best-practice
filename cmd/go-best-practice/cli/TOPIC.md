...
description: >-
  CLI UX (color, streaming output, output-alignment, dry-run, inline
...
This is a **category index**. `color`, `streaming`, `output-alignment`,
and `dry-run` are general CLI I/O UX; `inline-tui-mouse` is mouse
